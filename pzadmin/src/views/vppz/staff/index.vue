<template>
    ...
    <div class="btns">
        <el-button @click="openModel(null)" type="primary"  :icon="Plus">新增</el-button>
    ...
    <el-table :data="tableData.list" border stripe style="width: 100%" @selection-change="handleSelectionChange">
    ...
    <el-dialog v-model="dialogImgVisible" title="选择图片" width="500">
...
import { Plus, Delete, Select, InfoFilled } from '@element-plus/icons-vue'
